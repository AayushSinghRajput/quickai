...
const Hero = () => {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-gradient-to-r from-blue-50 to-indigo-50 bg-cover bg-no-repeat min-h-screen">
